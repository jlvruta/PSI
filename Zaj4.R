...
afinn <- read.csv(file.choose(), stringsAsFactors = FALSE)
bing <- read.csv(file.choose(), stringsAsFactors = FALSE)
loughran <- read.csv(file.choose(), stringsAsFactors = FALSE)
nrc <- read.csv(file.choose(), stringsAsFactors = FALSE)
