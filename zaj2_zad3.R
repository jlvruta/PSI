text_1<- readLines(file.choose('Downloads/Biden - State of the Union 2024.txt'))
text
text_2 <- readLines(file.choose('"Documents/Biden - First address to Congress_2021.txt"'))
text
